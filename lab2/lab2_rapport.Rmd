...
for(i in 1:2000) {
	beta1_mle[i] <- gamma_beta_mle(x = sample(x1, 10, replace =TRUE), alpha)
	beta2_mle[i] <- gamma_beta_mle(x = sample(x2, 10000, replace =TRUE), alpha)
...
Det blir mer chaotiskt, eftersom man har ett mer realistiskt scenario och därav inte blir lika normalfördelat. 
