...
# Corresponding alpha values to the maximal likelihood 
mu_list[which.max(results1)]
mu_list[which.max(results2)]
```
    
```{r, echo=FALSE, fig.show="hold", out.width="50%"}
    plot(mu_list, results1, type = "l", main= "Loglikelihood of x1 (model: normal)", xlab = "Mu", ylab="log-likelihood")
plot(mu_list, results2, type = "l", main= "Loglikelihood of x2 (model: normal)", xlab = "Mu", ylab="log-likelihood")
```
