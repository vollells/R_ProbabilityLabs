...
### 3)
```{r}
alpha_posterior <- maj_2020+alpha_guesses
uppgiftA  <- 0 
uppgiftB  <- 0
uppgiftC  <- 0
uppgiftD  <- 0
...
for (i in 1:n) {
    ...
    #Normalisering av partier under fyra % spärren
...
#Sannolikheten att de rödgröna är större än alliansen. 
uppgiftA/n

#Sannolikheten att SD är större än M
uppgiftB/n

#Sannolikheten att KD är under 4% spärren
uppgiftC/n

#Sannolikheten att MP åker ut ur riksdagen
uppgiftD/n
...
#Sannolikhetsintrevallet för Socialdemokraterna med 95% signifikans
lower
upper
```
